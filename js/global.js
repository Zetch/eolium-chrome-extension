  ...
  chrome.storage.local.get({
    ...
    if (preferences['eolium_header_compactMode']) {
      ...
      const user = {
        ...
        avatar: document.querySelector('#u-avatar-inner > img').getAttribute('src'),
        messages: 0
      };

      // Get PM count
      if (document.getElementById('u-badge-top')) {
        user.messages = parseInt(document.getElementById('u-badge-top').textContent);
      }
      ...
      (function(){
        ...
        const navbar = (function(){
          ...
          const userlinks = [
            ...
            ['ucp-posts',    'Mis mensajes',      '/search.php?search_id=egosearch&sr=posts'],
            ['ucp-threads',  'Mis hilos',         '/search.php?search_id=egosearch&sr=topics&sf=firstpost'],
          ...
          navbar.classList.add('navbar');
            ...
            row.classList.add('limit-width');
              ...
              logo.src = chrome.extension.getURL('images/eollogo.svg');
    ...
    if (preferences['eolium_other_hideGlobalAnnouces']) {
      const announces = document.querySelector('.section > .row.topic.announcement');
